    ...
    <div class="product-show-layout">
        ...
        <div class="product-info-column">
            ...
            @auth
                ...
                @else
                    <!-- Notice For Seller, Courier, Admin -->
                    <div class="role-restriction-box">
                        ...
                        <div>
                            ...
                            <div class="role-restriction-text">
                                You are signed in with a <strong>{{ ucfirst(auth()->user()->role) }}</strong> account. Purchasing and cart operations are reserved strictly for Buyer accounts.
                            </div>
                        </div>
                    </div>
                @endif
            @else
                <!-- Unauthenticated Guests are Prompted to Login as a Buyer -->
                <form action="{{ route('cart.add', $product->id) }}" method="POST" class="product-cart-form">
                    @csrf
                    <div class="product-qty-row">
                        <label class="product-qty-label">Quantity:</label>
